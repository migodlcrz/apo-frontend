...
const Calendar: React.FC<CalendarProps> = ({ selectedDate, onDateChange }) => {
  ...
  return (
    <div className="w-full mx-auto bg-white shadow-lg rounded-lg p-4 border border-gray-300">
      {/* Calendar Header */}
      ...
      {/* Day Labels */}
      <div className="grid grid-cols-7 gap-2 mb-2 text-gray-600 text-sm font-semibold">
